...
! @Date: 2023-06-16 20:48:51
 ...
 ! @LastEditTime: 2023-06-19 20:04:17
...
func main() {
	...
	name, _ := time.Now().Zone()
	losZone := fmt.Sprintf("当前时区: %s", name)
	...
	content2 := container.New(layout.NewVBoxLayout(), losInput, losZoneText, losPrompt, losButton, osResult)


	context := container.New(layout.NewVBoxLayout(), contentTitle, content1, button, result)
