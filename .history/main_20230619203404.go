...
! @Date: 2023-06-16 20:48:51
 ...
 ! @LastEditTime: 2023-06-19 20:32:12
...
func main() {
	...
	middle := widget.NewMultiLineEntry().Validator
	middle.Resize(fyne.NewSize(1, left.MinSize().Height))

	body := container.New(layout.NewGridLayout(3), content1, content, content2)
